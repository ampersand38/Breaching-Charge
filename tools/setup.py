...
def main():
    ...
    print("""
  ######################################
  # BCDW Development Environment Setup #
  ######################################

  This script will create your BCDW dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your BCDW project folder:
    [Arma 3 installation directory]\\{} => BCDW project folder
    P:\\{}                              => BCDW project folder
